...
Исправлена проблема нативных ChatGPT-приложений: iPhone и ChatGPT Classic
показывали ошибку региона, хотя браузер работал. Причина была в том, что
`UDP/443` уходил напрямую, и QUIC/HTTP3 обходил доменные правила Xray.
Публичный routing-пример блокирует `UDP/443`, чтобы приложения переходили на
TCP/443 и попадали в VLESS-маршрут ChatGPT/OpenAI.
